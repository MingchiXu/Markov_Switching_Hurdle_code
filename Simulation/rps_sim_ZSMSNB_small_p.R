...
cl <- parallel::makeCluster(3,
                            outfile=paste0("/lustre03/project/6003552/mingchi/ZSMSNB_sim_small_p_",T0,".txt"))
...
write.csv(gelman.matrix$psrf,paste0("/lustre03/project/6003552/mingchi/rps_result/ZSMSNB_gelman_sim_small_p_",as.character(T0),".csv"))
...
write.csv(dat.rps.zi,paste0("/lustre03/project/6003552/mingchi/rps_result/ZSMSNB_rps_sim_small_p",as.character(T0),".csv"))
write.csv(dat.logs.zi,paste0("/lustre03/project/6003552/mingchi/dss_result/ZSMSNB_logs_sim_small_p",as.character(T0),".csv"))
