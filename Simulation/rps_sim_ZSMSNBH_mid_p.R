...
# mid reporting rate (second small): p0=0.6
###################################################################
...
cases<-read.csv('/lustre03/project/6003552/mingchi/cases_60.csv')
...
cl <- parallel::makeCluster(3,
                            outfile=paste0("/lustre03/project/6003552/mingchi/ZSMSNBH_sim_mid_p_",as.character(T0),".txt"))
...
write.csv(gelman.matrix$psrf,paste0("/lustre03/project/6003552/mingchi/rps_result/ZSMSNBH_gelman_sim_mid_p_",as.character(T0),".csv"))
...
write.csv(dat.rps.h,paste0("/lustre03/project/6003552/mingchi/rps_result/ZSMSNBH_rps_sim_mid_p_",as.character(T0),".csv"))
write.csv(dat.logs.h,paste0("/lustre03/project/6003552/mingchi/dss_result/ZSMSNBH_logs_sim_mid_p_",as.character(T0),".csv"))
