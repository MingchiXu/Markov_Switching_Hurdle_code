...
#SBATCH --mem-per-cpu=113000M      # memory; default unit is megabytes
#SBATCH --time=136:00:00         # time (HH:MM:SS)
...
R -f rps-ZSMSNB-spatial-cluster.R --args $SLURM_ARRAY_TASK_ID
